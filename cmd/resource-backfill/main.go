...
//
// Copies finalized resource-contract rows into the compact read model used by
// /top_delegate and /top_stake. Safe to stop and rerun: inserts and per-day
// completion markers are idempotent.
func main() {
